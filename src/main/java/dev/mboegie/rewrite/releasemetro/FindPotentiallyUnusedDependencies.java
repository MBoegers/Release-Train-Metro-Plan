    ...
    public TreeVisitor<?, ExecutionContext> getVisitor() {
        return new JavaIsoVisitor<ExecutionContext>() {
            ...
            private String extractMeaningfulPackage(String fullImport) {
                if (fullImport == null) return null;
                
                // Extract meaningful package prefixes for common libraries
                if (fullImport.startsWith("org.springframework")) return "org.springframework";
                if (fullImport.startsWith("org.junit")) return "org.junit";
                if (fullImport.startsWith("org.slf4j")) return "org.slf4j";
                if (fullImport.startsWith("org.apache.commons")) return "org.apache.commons";
                if (fullImport.startsWith("org.apache.maven")) return "org.apache.maven";
                if (fullImport.startsWith("com.fasterxml.jackson")) return "com.fasterxml.jackson";
                if (fullImport.startsWith("io.micrometer")) return "io.micrometer";
                if (fullImport.startsWith("org.openrewrite")) return "org.openrewrite";
